...
main()
{
	...
	switch (op)
	{
		...
		case 'A':
		{
	        ...
	        scanf("%f",&tfa);
	        tka = (tfa*1.8)-459.67;
	        printf("\n   O Valor digitado convetido em Kelvin = %.2f\n", tka);
		...
		case 'B':
		{
	        ...
	        scanf("%f",&tkb);
	        tfb = (tfb+459.67)/1.8;
	        printf("\n   O Valor digitado convetido em Fahrenheit = %.2f\n", tkb);
	        printf("\n   Pressione qualquer tecla para continuar...");
			getch();
			break;
		}
		...
		{
			# Celsius para Kelvin
			printf("\n\n   Digite o Valor da Tempertaura em Celsius: ");
	        scanf("%f",&tcc);
	        tkc = (tcc)+273;
	        printf("\n   O Valor digitado convetido em Kelvin = %.2f\n", tkc);
	        printf("\n   Pressione qualquer tecla para continuar...");
		...
		{
			# Kelvin para Celsius
			printf("\n\n   Digite o Valor da Tempertaura em Kelvin: ");
	        scanf("%f",&tcd);
	        tkd = (tcd)-273.15;
 	        printf("\n   O Valor digitado convetido em Celsius = %.2f\n", tkd);
 	        printf("\n   Pressione qualquer tecla para continuar...");
 	        getch();
 	        break;
		}
